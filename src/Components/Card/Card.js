...
function Card({ id, url , handelClick, c}) {

  return (
    <div className="card-wrapper">
      <img className="card-img" src={url} alt="кошка" />
      <button  onClick={() => handelClick(c)} className="btn-like"><svg width="40" height="37" viewBox="0 0 40 37" fill="" xmlns="http://www.w3.org/2000/svg">
